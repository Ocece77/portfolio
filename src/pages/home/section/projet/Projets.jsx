  ...
  return (
    <>
      <Container fluid id="projets" className="row d-flex justify-content-center p-4">
        <Container fluid className="row row-cols-2 col-10">
          ...
          <Box lg="4" src={geoworld} name="Geoworld"  desc='Projets Geoworld réalisé pour mon BTS SIO'  url='https://github.com/Ocece77/geoworld'/>
          <Box lg="6" src={acf2l} name="ACF2L"  desc='Projet de groupe nommée AC2FL réalisé pour mon BTS SIO '  url='https://github.com/Ocece77/ACF2L'/>
